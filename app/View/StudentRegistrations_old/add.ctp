        ...
        <fieldset>
            ...
            <div class="form-area2">
                ...
                <div class="right-area"> 
                    <?php
                        echo $this->Form->input('nationality', array('maxlength' => '50', 'tabindex' => '18', 'empty' => 'Select','options'=>$nationalities, 'required' => false,'selected'=>$nationalityID,'onchange' => 'addforeign(), collegelist()'));
                    ?>
                    <div style="margin-left:180px;"><?php echo $this->Form->input('foreign_nationality', array('type'=>'hidden','tabindex' => '18', 'required' => false,'label'=>false));?></div>
                    <?php 
                    echo $this->Form->input('nationality_number', array('tabindex' => '18', 'required' => false));
                    ...
                    echo $this->Form->input('passport_number', array('tabindex' => '20', 'required' => false));
                    ...
                    echo $this->Form->input('guardian_nationality_number', array('tabindex' => '27', 'required' => false));
