    ...
    <div id="" class = "form-area2">
        ...
        <div class="<?php echo $class; ?>" <?php echo $cls; ?>>
            ...
            <table>
                <tr>
                    <td class="td-txt">
                        <strong><?php echo $college['College']['name']; ?></strong>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td class="td-txt" width="100px" ><strong>University:</strong></td>
                                <td class="td-txt"><?php echo $college['University']['name']; ?></td>
                            </tr>
                            <tr>
                                <td class="td-txt"><strong>City:</strong></td>
                                <td class="td-txt"> <?php echo $college['City']['name']; ?></td>
                            </tr>
                            <tr>
                                <td class="td-txt"><strong>State:</strong></td>
                                <td class="td-txt"><?php echo $college['State']['name']; ?></td>
                            </tr>
                            <tr>
                                <td class="td-txt"><strong>Contact Person: </strong></td>
                                <td class="td-txt"><?php echo $college['College']['contact_person']; ?></td>
                            </tr>
                            <tr>
                                <td class="td-txt"><strong>Contact No:</strong></td>
                                <td class="td-txt"> <?php echo $college['College']['phone_no']; ?></td>
                            </tr>
                            <tr>
                                <td class="td-txt"><strong>Email: </strong></td>
                                <td class="td-txt"><?php echo strtolower($college['College']['email']); ?></td>
                            </tr>
                            <tr>
                                <td class="td-txt"><strong>Web site:</strong></td>
                                <td class="td-txt"> <?php echo $college['College']['website']; ?></td>
                            </tr>
                            <tr>
                                <td class="td-txt"></td>
                                <td class="td-txt"> <?php echo $this->html->link('Qualifying Subjects', array('action'=>'course',$college['College']['id']));?></td>
                            </tr>
                        </table>
                    </td>
...
<!--            <table class="width:100%!important;">
                <tr>
                    <td width="20%" valign="top" align="left" colspan="5" style="word-wrap:break-word;">
                        <strong><?php //echo $college['College']['name']; ?></strong>
                    </td>
