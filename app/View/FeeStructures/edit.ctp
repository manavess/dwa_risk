...
<?php echo $this->Form->create('FeeStructure'); ?>
	<fieldset>
		<legend><?php echo __('Edit Fee Structure'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php //echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FeeStructure.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('FeeStructure.id'))); ?></li>
