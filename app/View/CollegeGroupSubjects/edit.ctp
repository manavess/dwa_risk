...
<?php echo $this->Form->create('CollegeGroupSubject'); ?>
	<fieldset>
		<legend><?php echo __('Edit College Group Subject'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CollegeGroupSubject.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CollegeGroupSubject.id'))); ?></li>
