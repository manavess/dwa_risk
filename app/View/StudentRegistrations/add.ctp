        ...
        <fieldset>
            ...
            <div class="form-area2">
                <div class="left-area">
                    ...
                    echo $this->Form->input('closest_relative_name', array('tabindex' => '5'));
                    echo $this->Form->input('closest_relative_add', array('tabindex' => '6'));
                    echo $this->Form->input('country_id', array('tabindex' => '7','options' => array('' => ' Select ',$countries), 'empty' => 'Select', 'id' => 'studentcountry','default'=>$countryID, 'style' => 'width:200px;','required'=>false));
                    echo $this->Form->input('state_id', array('tabindex' => '8', 'options' => array('' => ' Select ',$states), 'id' => 'countryState', 'style' => 'width:200px','selected'=>$stateID,'required'=>false));
                    echo $this->Form->input('city_id', array('tabindex' => '9', 'options' => array('' => ' Select ',$cities), 'id' => 'statecity', 'style' => 'width:200px','selected'=>$cityID,'required'=>false)); ?> 
                    
                    <?php
                    echo $this->Form->input('pincode', array('tabindex' => '10','maxlength'=>'8'));
                    echo $this->Form->input('gender', array('tabindex' => '11', 'type' => 'radio', 'class' => 'radio', 'checked' => 'checked', 'options' => $gender));
                    echo $this->Form->input('religion_id', array('tabindex' => '12', 'empty' => 'Select', 'id' => 'religion', 'style' => 'width:200px;', 'required' => false));
                    echo $this->Form->input('date_of_birth', array('tabindex' => '13', 'type' => 'text', 'id' => 'datepicker', 'required' => false,'dateformat'=>'d-m-Y','readonly'));
                    echo $this->Form->input('place_of_birth', array('tabindex' => '14','maxlength'=>'50','required' => false));
                    echo $this->Form->input('type_of_certificate', array('tabindex' => '15', 'required' => false));
                    echo $this->Form->input('certificate_index', array('tabindex' => '16', 'required' => false));
                    echo $this->Form->input('date_of_certificate', array('tabindex' => '17', 'type' => 'text','dateformat'=>'d-m-Y', 'id' => 'datepicker1', 'required' => true,'date','readonly'));
                    echo $this->Form->input('school_type', array('tabindex' => '18', 'empty' => 'Select','options'=>$schooltypes, 'required' => false,'selected'=>$schooltypeID));
                    echo $this->Form->input('secondary_school_name', array('tabindex' => '19', 'required' => false));
                    echo $this->Form->input('stream', array('tabindex' => '20', 'empty' => 'Select','options'=>$streams, 'required' => false,'selected'=>$streamID));
                    //echo $this->Form->input('course_id', array('tabindex' => '17', 'empty' => 'Select', 'id' => 'studentcourse', 'style' => 'width:200px;', 'required' => false));
                    ?>
                </div>
                <div class="right-area"> 
                    <?php
                        echo $this->Form->input('nationality', array('maxlength' => '50', 'tabindex' => '21', 'empty' => 'Select','options'=>$nationalities, 'required' => false,'selected'=>$nationalityID,'onchange' => 'addforeign(), collegelist()'));
                    ?>
                    <div style="margin-left:180px;"><?php echo $this->Form->input('foreign_nationality', array('type'=>'hidden','tabindex' => '22', 'required' => false,'label'=>false));?></div>
                    <?php 
                    echo $this->Form->input('nationality_number', array('tabindex' => '23', 'required' => false));
                    echo $this->Form->input('nationality_issue_date', array('tabindex' => '24', 'type' => 'text', 'id' => 'datepicker2','required' => false,'readonly'));
                    echo $this->Form->input('marital_status', array('tabindex' => '25', 'empty' => 'Select','options'=>$marital_status, 'required' => false,'selected'=>$marital_statusID));
                    echo $this->Form->input('passport_number', array('tabindex' => '26', 'required' => false));
                    echo $this->Form->input('passport_issue_date', array('tabindex' => '27', 'type' => 'text', 'id' => 'datepicker3', 'required' => false,'readonly','value'=>''));
                    echo $this->Form->input('admission_office', array('tabindex' => '28'));
                    //echo $this->Form->input('temporary_office', array('tabindex' => '23'));
                    echo $this->Form->input('submission_office', array('tabindex' => '29'));
                    echo $this->Form->input('guardian_name', array('tabindex' => '30', 'required' => false));
                    echo $this->Form->input('guardian_occupation', array('tabindex' => '31', 'required' => false));
                    echo $this->Form->input('guardian_nationality_number', array('tabindex' => '32', 'required' => false));
                    echo $this->Form->input('guardian_nationality_issue_date', array('tabindex' => '33', 'type' => 'text', 'id' => 'datepicker4', 'required' => false,'readonly'));
                    echo $this->Form->input('guardian_annual_income', array('tabindex' => '34', 'required' => false));
                    echo $this->Form->input('is_distance', array('tabindex' => '35', 'type' => 'radio', 'class' => 'radio', 'checked' => 'checked', 'options' => $isdistance, 'name' => 'distanceoption', 'onclick' => 'chkdistanceoption()'));
                    $emprefer = '';
                    ...
                    ?>
                    <div id="empreferer">
                   <?php echo $this->Form->input('is_emp_referance', array('tabindex' => '36', 'type' => 'radio', 'class' => 'radio','required'=>false, 'checked' => 'checked','options' => $empreference, 'name' => 'employee', 'onclick' => 'selectEmployee()','selected'=>$emprefer));
                    ?></div>
                    ...
                    <?php echo $this->Form->input('student_document', array('tabindex' => '37', 'type' => 'file')); ?>
                </div>
...
$(document).ready(function(){
    ...
    $(document).ready(function(){
     $('#totalPercentage').val('');
        ...
        $.ajax({
            type: 'POST',
            data: {nationality:$("#StudentRegistrationNationality").val(),AdmissionType:$("#admissiontype").val()},
    ...
    $('#StudentRegistrationStream').change(function() {
        $('#totalPercentage').val('');
        $('#collegelist').html('');
        $('#totalm').html('');
...
function  calculateValue() {
		...
		$(".subject_marks").each(function() {
	      ...
	      if(numeric.length>1){ numeric  = cleanArray(numeric); }
            ...
            if(grdpointval.length >= 5 || alphbeticval.length >= 5  || numeric.length >= 5) {
		...
		if (alphbeticval.length >= 5 || grdpointval.length >= 5 || numeric.length >= 5) {
		    if (marks_system == 'G') {
		        if (alphbeticval.length >= 5) {
		        ...
		        if (marks_system == 'M' || numeric.length >= 5) {
...
//		}
		...
		if(status==true && maturestdstatus==true && agestatus==true && qualifyper==true && iscity==true && isColleges==true && stream==true && collegestatus==true && birthissuedate==true && compstatus==true){
