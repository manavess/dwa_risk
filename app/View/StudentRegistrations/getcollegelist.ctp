	...
	';
        if (!empty($colleges)) {
            foreach ($colleges as $college) {
                ...
                if ($isvalid)
                    $option .= "<option value='{$collegegrpid}','rel'=''>{$this->StdRegistrations->getuniversity($college['College']['university_id'])}  {$college['College']['college_code']}  {$college['GroupSubjects']['name']} </option>";
        ...
        if (!empty($selectedCollegeData)) {
            ...
            foreach ($selectedCollegeData as $selected) {
                ...
                if (!empty($selected['StudentPreferedColleges']['college_id'])) {
                    ...
                    $option .= "<option selected='selected' value='{$selectedgrpid}','rel'=''>{$this->StdRegistrations->getuniversity($selected['CollegeGroupSubject']['College']['university_id'])}  {$selected['CollegeGroupSubject']['College']['college_code']}  {$selected['CollegeGroupSubject']['GroupSubjects']['name']}</option>";
                }
            }
        }
	...
	';
        if (!empty($colleges)) {
             ...
             foreach ($colleges as $college) {
                ...
                $collegegrpid = $college['CollegeGroupSubject']['college_id'].",".$college['CollegeGroupSubject']['id'];
                if ($isvalid)
                    $option .= "<option value='{$collegegrpid}','rel'=''>{$college['College']['University']['name']}  {$college['College']['college_code']}  {$college['GroupSubjects']['name']}</option>";
            }
        }
        ...
        if (!empty($colleges)) {
            foreach ($colleges as $privatecollegeoption) {
                $isvalid = true;
                    ...
                    foreach ($selectedCollegeData as $selected) {
                        ...
                        if ($selected['StudentPreferedColleges']['college_id'] == $privatecollegeoption['CollegeGroupSubject']['College']['id']) {
                            $option .= "<option selected='selected' value='{$collegegrpid}'>{$this->StdRegistrations->getuniversity($privatecollegeoption['CollegeGroupSubject']['College']['university_id'])}  {$privatecollegeoption['CollegeGroupSubject']['College']['college_code']}  {$privatecollegeoption['GroupSubjects']['name']}</option>";
                        }
                    }
                ...
                if(!empty($group_subject) && array_search($privatecollegeoption['College']['id'], $group_subject)){
                    ...
                    $option .= "<option value='{$collegegrpid}'>{$this->StdRegistrations->getuniversity($privatecollegeoption['College']['university_id'])}  {$privatecollegeoption['College']['college_code']}  {$privatecollegeoption['GroupSubjects']['name']} {$subkey}</option>";
                }
                $subkey='';
            }
        }
                ...
                if(!empty($selectedCollegeData)){
                    foreach ($selectedCollegeData as $selected) {
                        ...
                        if ($selected['StudentPreferedColleges']['college_id'] == $privatecollegeoption['CollegeGroupSubject']['college_id']) {
                            $option .= "<option selected='selected' value='{$collegegrpid}'>{$this->StdRegistrations->getuniversity($selected['CollegeGroupSubject']['College']['university_id'])}  {$selected['CollegeGroupSubject']['College']['college_code']}  {$selected['CollegeGroupSubject']['GroupSubjects']['name']}</option>";
                        }
                    }
                }

                    $collegegrpid = $privatecollegeoption['College']['id'].",".$privatecollegeoption['CollegeGroupSubject']['id']; 
                    $option .= "<option value='{$collegegrpid}'>{$this->StdRegistrations->getuniversity($privatecollegeoption['College']['university_id'])}  {$privatecollegeoption['College']['college_code']}  {$privatecollegeoption['GroupSubjects']['name']}</option>";
