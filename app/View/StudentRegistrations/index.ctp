...
<?php  echo $this->Html->addCrumb("Student Admission", '/StudentRegistrations'); ?>
	...
	?>
        <tr>
            ...
            <td><?php echo $studentRegistration['StudentRegistration']['application_number']; ?></td>
            ...
            <td><?php 
            if($this->StdRegistrations->getpercentage($studentRegistration['StudentRegistration']['total_percentage'])){
                echo $this->StdRegistrations->getpercentage($studentRegistration['StudentRegistration']['total_percentage']); 
                
            }else{ 
                echo h($studentRegistration['StudentRegistration']['total_percentage']); 
                } 
            ?>&nbsp;
            </td>
            <td> <?php //$this->StdRegistrations->isallotted($studentRegistration['StudentRegistration']['id']); ?>
                        <?php if($this->StdRegistrations->isallotted($studentRegistration['StudentRegistration']['id'])){ 
                            echo "Yes"; 
                            
                        }else{ 
                            echo "No"; 
                        }
//echo $this->Html->link($studentRegistration['Employee']['name'], array('controller' => 'employees', 'action' => 'view', $studentRegistration['Employee']['id'])); ?>
            </td>
            <td>
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link('Download Non-Nominated Students',array('action'=>'download_non_nominated_student'))?></li>
    </ul>
