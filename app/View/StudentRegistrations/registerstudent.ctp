...
//                    }
            ...
            <div class="form-area2">
                ...
                <div class="right-area"> 
                    ...
                    echo $this->Form->input('passport_number', array('tabindex' => '21','required'=>false));
...
$('#totalPercentage').val('');
        ...
        $.ajax({
            type: 'POST',
            data: {AdmissionType:'N',certificate_index:certnum},
...
//		alert("hi");
		...
		if(qualifyper==true && collegestatus==true){
