...
<td><?php echo @$exceptionallotment['Colleges']['name']
		; ?>&nbsp;</td>		
		...
		<td <?php echo $cssclass;?>>
                    <table><tr><td><?php echo @$exceptionallotment[0]['malecount']; ?>&nbsp;</td><td><?php echo @$exceptionallotment[0]['femalecount']; ?>&nbsp;</td><td><?php echo @$exceptionallotment[0]['opt']; ?>&nbsp;</td></tr></table>
                    
                </td>		
                <td><?php if(!empty($exceptionallotment['Colleges']['id'])){ echo $this->StdRegistrations->getlastadmper($exceptionallotment['Colleges']['id'],$exceptionallotment['StudentAlotment']['allocation_year']); } ?><?php //echo "%";  ?></td>
